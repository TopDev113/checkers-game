...
func init() {
	...
	md_MsgCreateGame = File_topdev113_checkers_v1_tx_proto.Messages().ByName("MsgCreateGame")
...
func (x *fastReflection_MsgCreateGame) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "topdev113.checkers.v1.MsgCreateGame.creator":
		return x.Creator != ""
	case "topdev113.checkers.v1.MsgCreateGame.index":
		return x.Index != ""
	case "topdev113.checkers.v1.MsgCreateGame.black":
		return x.Black != ""
	case "topdev113.checkers.v1.MsgCreateGame.red":
		return x.Red != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: topdev113.checkers.v1.MsgCreateGame"))
		}
		panic(fmt.Errorf("message topdev113.checkers.v1.MsgCreateGame does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateGame) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message topdev113.checkers.v1.MsgCreateGame does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateGame) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "topdev113.checkers.v1.MsgCreateGame.creator":
		panic(fmt.Errorf("field creator of message topdev113.checkers.v1.MsgCreateGame is not mutable"))
	case "topdev113.checkers.v1.MsgCreateGame.index":
		panic(fmt.Errorf("field index of message topdev113.checkers.v1.MsgCreateGame is not mutable"))
	case "topdev113.checkers.v1.MsgCreateGame.black":
		panic(fmt.Errorf("field black of message topdev113.checkers.v1.MsgCreateGame is not mutable"))
	case "topdev113.checkers.v1.MsgCreateGame.red":
		panic(fmt.Errorf("field red of message topdev113.checkers.v1.MsgCreateGame is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: topdev113.checkers.v1.MsgCreateGame"))
		}
...
func (x *fastReflection_MsgCreateGame) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in topdev113.checkers.v1.MsgCreateGame", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_topdev113_checkers_v1_tx_proto_init()
	md_MsgCreateGameResponse = File_topdev113_checkers_v1_tx_proto.Messages().ByName("MsgCreateGameResponse")
}
...
func (x *fastReflection_MsgCreateGameResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: topdev113.checkers.v1.MsgCreateGameResponse"))
		}
		panic(fmt.Errorf("message topdev113.checkers.v1.MsgCreateGameResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateGameResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message topdev113.checkers.v1.MsgCreateGameResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateGameResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in topdev113.checkers.v1.MsgCreateGameResponse", d.FullName()))
	}
	panic("unreachable")
}
...
var file_topdev113_checkers_v1_tx_proto_rawDesc = []byte{
	...
	0x2e, 0x74, 0x6f, 0x70, 0x64, 0x65, 0x76, 0x31, 0x31, 0x33, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b,
	0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x73, 0x67, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x47, 0x61, 0x6d, 0x65, 0x1a, 0x2c, 0x2e, 0x74, 0x6f, 0x70, 0x64, 0x65, 0x76, 0x31, 0x31, 0x33,
...
var file_topdev113_checkers_v1_tx_proto_goTypes = []interface{}{
	(*MsgCreateGame)(nil),         // 0: topdev113.checkers.v1.MsgCreateGame
	(*MsgCreateGameResponse)(nil), // 1: topdev113.checkers.v1.MsgCreateGameResponse
}
var file_topdev113_checkers_v1_tx_proto_depIdxs = []int32{
	0, // 0: topdev113.checkers.v1.Msg.CreateGame:input_type -> topdev113.checkers.v1.MsgCreateGame
	1, // 1: topdev113.checkers.v1.Msg.CreateGame:output_type -> topdev113.checkers.v1.MsgCreateGameResponse
