...
func (*QueryGetGameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d9634bc8286c85e5, []int{0}
}
...
func (*QueryGetGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d9634bc8286c85e5, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryGetGameRequest)(nil), "topdev113.checkers.v1.QueryGetGameRequest")
	proto.RegisterType((*QueryGetGameResponse)(nil), "topdev113.checkers.v1.QueryGetGameResponse")
}

func init() { proto.RegisterFile("topdev113/checkers/v1/query.proto", fileDescriptor_d9634bc8286c85e5) }

var fileDescriptor_d9634bc8286c85e5 = []byte{
	// 308 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x2c, 0xc9, 0x2f, 0x48,
	...
	0x28, 0x89, 0x0d, 0x1c, 0xb8, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x5a, 0x2f, 0xc7, 0x78,
	0x0c, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) GetGame(ctx context.Context, in *QueryGetGameRequest, opts ...grpc.CallOption) (*QueryGetGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/topdev113.checkers.v1.Query/GetGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/topdev113.checkers.v1.Query/GetGame",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "topdev113.checkers.v1.Query",
	...
	Metadata: "topdev113/checkers/v1/query.proto",
}
