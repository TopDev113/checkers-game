...
func (*ReqCheckersTorramEnd) Descriptor() ([]byte, []int) {
	return fileDescriptor_65444e2b99dcc4a2, []int{2}
}
...
func init() {
	...
	proto.RegisterType((*ReqCheckersTorramEnd)(nil), "topdev113.checkers.v1.ReqCheckersTorramEnd")
}
...
var fileDescriptor_65444e2b99dcc4a2 = []byte{
	...
	,
}
...
func (c *checkersTorramClient) CheckersEndGm(ctx context.Context, in *ReqCheckersTorramEnd, opts ...grpc.CallOption) (*ResCheckersTorram, error) {
	out := new(ResCheckersTorram)
	err := c.cc.Invoke(ctx, "/topdev113.checkers.v1.CheckersTorram/CheckersEndGm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CheckersTorram_CheckersEndGm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/topdev113.checkers.v1.CheckersTorram/CheckersEndGm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
